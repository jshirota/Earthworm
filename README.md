...
-Does not require any autogenerated code.  No XML mapping files.  No dependency on the IDE.
...
-Returns mapped objects as a lazy sequence implementing IEnumerable<T>.  Allows LINQ code.
