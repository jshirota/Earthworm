...
namespace Earthworm
{
    ...
    public static class EntityExtensions
    {
        ...
        /// <returns></returns>
        public static IEnumerable<T> Map<T>(this ITable table, IQueryFilter filter = null) where T : Entity
        {
        ...
        /// <param name="filter"></param>
        /// <returns></returns>
        public static IEnumerable<T> Map<T>(this IFeatureClass featureClass, IQueryFilter filter = null) where T : Entity
        {
